...
/** Список платежей с возможностью подтверждения оплаты. */
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="space-y-1 text-sm">
                ...
                <div className="text-muted-foreground">{payment.tenant.name}</div>
                <div>
              ...
              <div className="flex flex-col items-end gap-2">
                <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold ${statusStyles[payment.status] || ''}`}>
